...
<div class="container-fluid py-0 px-0">
    <h1 class="h3 mb-3"><strong>{{ ucwords(str_replace('_', ' ', 'edit_client')) }}</strong></h1>
            ...
            <form action="{{ route('clients.update', $client->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="prefix" id="prefix" class="form-control"
                        value="{{ old('prefix', $client->prefix) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="organization" id="organization" class="form-control"
                        value="{{ old('organization', $client->organization) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="role" id="role" class="form-control"
                        value="{{ old('role', $client->role) }}" required>
                </div>
