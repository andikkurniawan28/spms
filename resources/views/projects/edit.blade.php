...
<div class="container-fluid py-0 px-0">
    <h1 class="h3 mb-3"><strong>{{ ucwords(str_replace('_', ' ', 'edit_project')) }}</strong></h1>
            ...
            <form action="{{ route('projects.update', $project->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="prefix" id="prefix" class="form-control"
                        value="{{ old('prefix', $project->prefix) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="fullname" id="fullname" class="form-control"
                        value="{{ old('fullname', $project->fullname) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nickname" id="nickname" class="form-control"
                        value="{{ old('nickname', $project->nickname) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="phone" id="phone" class="form-control"
                        value="{{ old('phone', $project->phone) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="organization" id="organization" class="form-control"
                        value="{{ old('organization', $project->organization) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="birthday" id="birthday" class="form-control"
                        value="{{ old('birthday', $project->birthday) }}">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="id_number" id="id_number" class="form-control"
                        value="{{ old('id_number', $project->id_number) }}">
                </div>
